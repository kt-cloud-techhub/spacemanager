# AI-DLC Workflow Diagram

> Stage descriptions and execution logic → see `rules/workflow.md`

## Three-Phase Overview

- **INCEPTION**: Planning and architecture — determine WHAT and WHY
- **CONSTRUCTION**: Design, implementation, build and test — determine HOW
- **OPERATIONS**: Placeholder for future deployment and monitoring
...
**Legend**: Solid border = ALWAYS execute · Dashed border = CONDITIONAL
