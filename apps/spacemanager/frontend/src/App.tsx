...
import { MapPin, Users, LayoutDashboard, Settings, CheckCircle, ChevronLeft, ChevronRight, X } from 'lucide-react';
import { fetchSeats, fetchFloors, reserveSeat, runSimulation, fetchAssignments, saveAssignment, moveSeat, cancelSeatReservation } from './api/api';
